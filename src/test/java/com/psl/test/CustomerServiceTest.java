...
public class CustomerServiceTest {
	...
	/*
	 * @Test public void testCustomerListNegative(){
	 * 
	 * CustomerTestConfig cds = new CustomerTestConfig();
	 * 
	 * CustomerService cs = cds.getService();
	 ...
	 * List<Customer> checkList = new ArrayList<Customer>();
	 * 
	 * Customer c1 = new Customer(); c1.setFirstName("Shubham");
	 * checkList.add(c1); Customer c2 = new Customer();
	 * c2.setFirstName("Poonam"); checkList.add(c2); Customer c3 = new
	 * Customer(); c3.setFirstName("Ajit"); checkList.add(c3);
	 *
	 * List<Customer> dbValues = service.getAllCustomers();
	 * Assert.assertTrue(dbValues.size()<=0); //
	 * Assert.assertTrue(checkList.size()==dbValues.size());
	...
	public void testAddCustomer() {
		...
		Assert.assertEquals("class com.psl.service.DaoService", this.service
				.getClass().toString());
